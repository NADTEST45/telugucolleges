...
export const ADMISSION_EXAMS: AdmissionExam[] = [
  ...
  {
    examName: "AP EAPCET / JEE Main",
    examFullName: "GMRIT admits primarily through AP EAPCET counselling",
    officialUrl: "https://gmrit.edu.in/",
    applicationFee: "AP EAPCET: ₹600 (General) / ₹500 (BC) / ₹250 (SC/ST)",
    mode: "Online CBT (AP EAPCET)",
    duration: "3 hours (AP EAPCET)",
    subjects: "Physics, Chemistry, Mathematics",
    eligibility: "10+2 with PCM, minimum 45% (40% for SC/ST)",
    phases: [
      { phase: "AP EAPCET 2026", examDates: "Engineering: May 12–15, 18, 2026", lastDateToApply: "Apr 10, 2026 (with late fee)", resultDate: "Jun 1, 2026 (expected)" },
      { phase: "APSCHE Counselling", examDates: "Jul 2026 (multiple rounds)", lastDateToApply: "Post results" },
    ],
    alternateEntry: "70% seats via AP EAPCET counselling; remaining via JEE Main or management quota",
    counsellingNote: "GMRIT admits via APSCHE centralised counselling. No standalone entrance exam.",
    collegeCodes: ["GMRI"],
  },
  ...
  {
    examName: "AP EAPCET / JEE Main",
    examFullName: "MITS Madanapalle admits primarily through AP EAPCET",
    ...
    alternateEntry: "Also accepts JEE Main scores. Apply directly at admission.mits.ac.in for management quota seats.",
    counsellingNote: "MITS admits primarily via APSCHE centralised counselling. No standalone university entrance exam.",
    collegeCodes: ["MITS"],
  },

  // ── Siddhartha Academy of Higher Education (formerly VR Siddhartha) ──
  {
    examName: "AP EAPCET / JEE Main",
    examFullName: "VR Siddhartha admits primarily through AP EAPCET",
    officialUrl: "https://www.vrsiddhartha.ac.in/admission-procedure/",
    applicationFee: "AP EAPCET: ₹600 (General) / ₹500 (BC) / ₹250 (SC/ST)",
    mode: "Online CBT (AP EAPCET)",
    duration: "3 hours (AP EAPCET)",
    subjects: "Physics, Chemistry, Mathematics",
    ...
    phases: [
      { phase: "AP EAPCET 2026", examDates: "Engineering: May 12–15, 18, 2026", lastDateToApply: "Apr 10, 2026 (with late fee)", resultDate: "Jun 1, 2026 (expected)" },
      { phase: "APSCHE Counselling (70% seats)", examDates: "Jul 2026 (multiple rounds)", lastDateToApply: "Post results" },
      { phase: "Category B (Management Quota, 30%)", examDates: "Direct admission window — tentatively till May 25, 2026", lastDateToApply: "May 25, 2026 (tentative)" },
    ],
    alternateEntry: "Also accepts JEE Main scores. 30% Category-B (management quota) seats filled directly via university application.",
    counsellingNote: "VR Siddhartha admits via APSCHE counselling for Category A, direct admission for Category B.",
    collegeCodes: ["VRSE"],
  },
  ...
  // ── Audisankara College of Engineering and Technology (Gudur, Nellore) ──
  {
    examName: "AP EAPCET / JEE Main",
    examFullName: "Audisankara admits primarily through AP EAPCET",
    ...
    alternateEntry: "Also accepts AP PGECET, AP POLYCET, AP ICET scores for relevant courses",
    counsellingNote: "Audisankara is affiliated to JNTUA and admits via APSCHE counselling. ~80% of UG students receive financial aid.",
    collegeCodes: ["AUDI"],
  },

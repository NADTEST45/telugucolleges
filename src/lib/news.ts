...
export const NEWS_ITEMS: NewsItem[] = [
  {
    ...
    summary: "The TG engineering spot-admission guidelines scheduled admissions for August 19–20. The separate MPC pharmacy allotment is scheduled by September 6. The current AP counselling round could not be confirmed during this review.",
    body: "The TGCHE detailed notification scheduled final-phase reporting through August 7 and internal-sliding reporting through August 17, 2026. These published windows are now in the past. The official 2026 spot-admission guidelines also scheduled institutional engineering spot admissions for August 19–20. Do not treat the portal vacancy links as evidence that this window remains open.\n\nA separate notification for MPC-stream B.Pharmacy and Pharm.D schedules allotment on or before September 6, fee payment and self-reporting September 6–7, and college reporting September 7–8. Candidates already admitted to engineering are not eligible to exercise options in this round. This is not an engineering admission extension.\n\nThe AP results form is available, but the AP counselling portal could not be reached during our September 5 review. This does not establish whether registration is open or closed. Use the official AP counselling portal to confirm your round and reporting requirements.\n\nOur cutoff tables remain historical references, with their source years shown. They are not official 2026 closing ranks or guarantees of a seat.",
    category: "counselling",
    state: "Both",
    priority: "medium",
    source: "TGCHE — engineering spot guidelines and separate MPC pharmacy notification",
  ...
  // ── New: July 17, 2026 ────────────────────────────────────────
  {
    ...
    date: "2026-07-17",
    title: "AP EAPCET 2026 Counselling Schedule Notified — Registration July 20–29, Web Options July 25–31, Allotment August 6",
    summary: "APSCHE has officially notified the AP EAPCET 2026 first-phase counselling schedule. Registration and processing-fee payment run July 20–29, certificate verification July 22–31, and web options entry July 25–31, with August 1 to change options. Seat allotments are released August 6; self-joining and reporting runs August 7–13 and classes begin August 10.",
    body: "The Andhra Pradesh State Council of Higher Education (APSCHE) has notified the first-phase counselling schedule for AP EAPCET 2026 admissions. The admission committee met on July 15, the notification was issued on July 16, and it was published in newspapers on July 17, 2026.\n\nAP EAPCET 2026 first-phase counselling schedule:\n• Registration cum payment of processing fee: July 20 – 29, 2026 (10 days)\n• Verification of uploaded certificates at Help Line Centres, online: July 22 – 31, 2026 (10 days)\n• Web options entry: July 25 – 31, 2026 (7 days)\n• Changing of web options: August 1, 2026\n• Release of seat allotments: August 6, 2026\n• Self joining and reporting at college: August 7 – 13, 2026 (7 days)\n• Attending classes at college: August 10, 2026\n\nWhere the process runs: registration, fee payment and web options are all on eapcet-sche.aptonline.in. The processing fee is ₹1,200 for OC/BC candidates and ₹600 for SC/ST candidates. Rank cards, declared on July 1, are on cets.apsche.ap.gov.in.\n\nThings worth noting about this schedule:\n• There is no mock allotment in this phase. Unlike TG EAPCET, which publishes a mock allotment before final freezing, AP goes straight from the August 1 change-of-options day to the real seat allotment on August 6 — so August 1 is your last chance to fix your priority order.\n• Certificate verification and web options overlap (July 25–31), but verification must be completed for your options to be considered. Do not leave verification to the last days.\n• Classes begin August 10 while reporting runs to August 13, per the official schedule.\n• Only the first phase has been notified. Later phases have not been announced yet.\n\nWhat to do now:\n1. Download and save your rank card from cets.apsche.ap.gov.in if you haven't already\n2. Get your certificates ready and uploaded — hall ticket, rank card, SSC and Intermediate memos, Transfer Certificate, study/bonafide certificates for local-area status, income certificate for fee reimbursement, and caste/EWS certificate if applicable\n3. Register and pay the processing fee early in the July 20–29 window rather than on the closing days\n4. Build a long college+branch priority list before July 25 — candidates who enter too few options regularly go unallotted even when their rank could have secured a seat\n\nAlways confirm dates against the official notification on cets.apsche.ap.gov.in before acting.",
    category: "counselling",
    state: "AP",
    priority: "high",
    source: "APSCHE — APEAPCET-2026 Admissions Counselling Schedule (first phase notification)",
    sourceUrl: "https://cets.apsche.ap.gov.in",
    verifiedAt: "2026-07-17T09:00:00+05:30",
    expiresAt: "2026-07-25T00:00:00+05:30",
    tags: ["AP EAPCET", "AP EAMCET", "Counselling", "Web Options", "Seat Allotment", "2026"],
  },
  // ── New: July 14, 2026 ───────────────────────────────────────
  {

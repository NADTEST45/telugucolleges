...
export const NEWS_ITEMS: NewsItem[] = [
  // ── New: March 26, 2026 ────────────────────────────────────────
  {
    ...
    date: "2026-03-26",
    title: "AP EAPCET 2026 — Application Correction Window Open Today (March 26–28)",
    summary: "APSCHE has opened the AP EAPCET 2026 application form correction window from March 26 to 28. Candidates can fix mistakes in their submitted forms.",
    body: "The AP EAPCET 2026 application form correction window is now open.\n\n• Correction window: March 26–28, 2026\n• Category 2 corrections (photo, signature, etc.): Edit directly on cets.apsche.ap.gov.in\n• Category 1 corrections (name, DOB, caste): Email helpdesk with supporting documents\n\nCandidates who submitted their applications before the March 24 deadline should review their forms carefully and correct any errors during this window. This is the only opportunity to fix mistakes before admit cards are generated.\n\nUpcoming dates: Admit card download from April 28 | Engineering exam: May 12–15 & 18 | Result: June 1, 2026.",
    category: "eapcet",
    state: "AP",
    priority: "high",
    source: "APSCHE",
    sourceUrl: "https://cets.apsche.ap.gov.in/EAPCET/",
    tags: ["AP EAPCET", "Correction Window", "Application Form", "2026"],
  },
  {
    id: "jee-main-2026-session-2-april",
    date: "2026-03-26",
    title: "JEE Main 2026 Session 2 — Exam April 2–9, Admit Cards Expected This Week",
    summary: "NTA will conduct JEE Main 2026 Session 2 from April 2 to 9. City intimation slips are out; admit cards expected by end of March.",
    body: "JEE Main 2026 Session 2 is just a week away.\n\n• Exam dates: April 2–9, 2026 (CBT mode)\n• Shifts: Morning (9 AM – 12 PM) and Afternoon (2 PM – 5 PM)\n• City intimation slips: Already released at jeemain.nta.nic.in\n• Admit cards: Expected in the last week of March (3–4 days before exam)\n• Result: Expected by April 20, 2026\n\nSession 2 results will include JEE Advanced 2026 qualification cutoffs and All India Ranks. Candidates who appeared in both sessions will be awarded the better of the two NTA scores.\n\nFor students targeting AP/TS private and deemed universities — JEE Main scores are accepted by GITAM (GAT waiver), KL University, SRM AP, and Vignan's (V-SAT waiver) for direct admission.",
    category: "general",
    state: "Both",
    priority: "high",
    source: "NTA",
    sourceUrl: "https://jeemain.nta.nic.in/",
    tags: ["JEE Main", "Session 2", "NTA", "Admit Card", "2026"],
  },
  {
    id: "tg-eapcet-2026-registration-deadline-april-4",
    date: "2026-03-26",
    title: "TG EAPCET 2026 — Last Date to Apply Without Late Fee: April 4",
    summary: "2.2 lakh students have already registered for TG EAPCET 2026. Regular registration closes April 4; late fee applications accepted until May 2.",
    body: "TG EAPCET (formerly TS EAMCET) 2026 registration is ongoing with strong numbers.\n\n• Applications so far: 2.2 lakh+\n• Last date without late fee: April 4, 2026\n• Late fee schedule: ₹250 (Apr 5–12), ₹500 (Apr 13–20), ₹1,000 (Apr 21–25), ₹2,000 (Apr 26–28), ₹10,000 (Apr 29–May 2)\n• Form correction window: April 6–8, 2026\n• Engineering exam: May 9–11, 2026\n• Agriculture/Pharmacy exam: May 4–5, 2026\n• Official website: eapcet.tgche.ac.in\n\nThe exam will have 160 MCQs for 160 marks with no negative marking. Two shifts per day — 9 AM to 12 PM and 3 PM to 6 PM.\n\nFor corrections, email tgeapcethelpdesk2026@jntuh.ac.in with supporting documents.",
    category: "eapcet",
    state: "TS",
    priority: "high",
    source: "TGCHE / JNTU Hyderabad",
    sourceUrl: "https://eapcet.tgche.ac.in/",
    tags: ["TG EAPCET", "TS EAMCET", "Registration", "Deadline", "2026"],
  },
  {
    id: "ap-icet-2026-late-fee-deadline-march-26",
    date: "2026-03-26",
    title: "AP ICET 2026 — Apply Today with ₹1,000 Late Fee (MBA/MCA Admissions)",
    summary: "Today is the last date to apply for AP ICET 2026 with a ₹1,000 late fee. Further late fee windows open up to April 5. Exam on May 2.",
    body: "AP ICET 2026 (for MBA/MCA admissions) registration deadline updates:\n\n• Regular deadline: Closed (March 23)\n• With ₹1,000 late fee: Today, March 26, 2026 (last day!)\n• With ₹2,000 late fee: March 29, 2026\n• With ₹4,000 late fee: April 1, 2026\n• With ₹10,000 late fee: April 5, 2026\n• Exam date: May 2, 2026\n• Apply at: cets.apsche.ap.gov.in/ICET\n\nAP ICET is conducted by APSCHE for admission to MBA and MCA programs in AP-affiliated universities and colleges. Students seeking management or computer application programs in AP should apply before the late fee increases further.",
    category: "general",
    state: "AP",
    priority: "medium",
    source: "APSCHE",
    sourceUrl: "https://cets.apsche.ap.gov.in/ICET/",
    tags: ["AP ICET", "MBA", "MCA", "Registration", "Late Fee", "2026"],
  },
  // ── New: March 17, 2026 ────────────────────────────────────────
  {

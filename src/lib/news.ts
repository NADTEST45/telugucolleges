...
export const NEWS_ITEMS: NewsItem[] = [
  // ── New: May 19, 2026 ─────────────────────────────────────────
  {
    ...
    date: "2026-05-19",
    title: "AP EAPCET 2026 — Engineering Exam Concludes May 18, Preliminary Key on May 23",
    summary: "AP EAPCET 2026 Engineering was conducted across five days (May 12, 13, 14, 15 & 18). The preliminary answer key and response sheets will be released on May 23 with an objection window until May 25. Result: June 1, 2026.",
    body: "JNTU Kakinada has successfully concluded the AP EAPCET 2026 Engineering examination on May 18, 2026. The exam was held over five days (May 12, 13, 14, 15 and 18) in two daily shifts of three hours each.\n\nNext steps:\n• Preliminary answer key + individual response sheets: May 23, 2026 (Saturday) at cets.apsche.ap.gov.in\n• Objection window: 48 hours — close on May 25, 2026 (Monday)\n• Final result + rank card: June 1, 2026\n• Agriculture/Pharmacy (APECET) stream: May 19–20, 2026\n\nHow objections work: After downloading the preliminary key from the candidate login (hall ticket + DOB), students can challenge any question via the \"Key Objections\" link. Each objection must include the disputed question ID, a clear reason and supporting evidence (textbook scan, derivation, etc.) — APSCHE will review all objections before publishing the final key alongside the result.\n\nWhat to do now: Download and save your response sheet on May 23; cross-check with the preliminary key; raise objections only with citable evidence. AP EAPCET counselling is expected to begin in the first week of July 2026, conducted by APSCHE in two regular rounds plus a spot round. Convenor-quota fees for the 2025–28 block are governed by APHERMC; management-quota fees by individual colleges.",
    category: "eapcet",
    state: "AP",
    priority: "high",

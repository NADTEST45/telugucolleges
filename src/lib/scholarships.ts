...
export const SCHOLARSHIPS: Record<string, ScholarshipInfo> = {
  ...
  "KLUN": {
    ...
    notes: [
      "Board-based scholarships also available (CBSE/State Board)",
      "TS/AP State Board: ≥96% gets 50% concession",
  ...
  "VIGF": {
    ...
    notes: [
      ...
      "VSAT (Vignan's own exam) is the primary admission route",
      "JEE Main and EAPCET ranks also considered for scholarship allocation",
    ],

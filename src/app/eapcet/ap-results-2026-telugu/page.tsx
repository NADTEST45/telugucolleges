...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "ఫలితం వచ్చిన వారం రోజుల్లో eapcet-sche.aptonline.in లో కౌన్సెలింగ్ రిజిస్ట్రేషన్ ప్రారంభమవుతుందని భావిస్తున్నారు. ఈ ప్రక్రియలో రిజిస్ట్రేషన్ & ఫీజు చెల్లింపు, సర్టిఫికెట్ వెరిఫికేషన్, వెబ్ ఆప్షన్ల నమోదు, దశలవారీ సీట్ కేటాయింపు ఉంటాయి.",
  },
];
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <p className="text-sm text-gray-600 mb-6 leading-relaxed">
        చివరిగా నవీకరించబడింది: <strong>1 జూలై 2026</strong>. ఏపీ ఈఏపీసెట్ 2026 ఫలితాలు{" "}
      ...
      <section className="bg-white rounded-xl p-4 sm:p-6 shadow-sm mb-6">
        ...
        <p className="text-sm text-gray-700 leading-relaxed mb-3">
          ...
          వెరిఫికేషన్, వెబ్ ఆప్షన్ల నమోదు, సీట్ కేటాయింపు, సెల్ఫ్ రిపోర్టింగ్. ఫలితం విడుదలైనందున,
          వారం రోజుల్లో APSCHE కౌన్సెలింగ్ షెడ్యూల్‌ను ప్రకటించే అవకాశం ఉంది; రౌండ్ 1 జూలై 2026లో

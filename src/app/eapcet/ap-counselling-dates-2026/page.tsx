...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Registration opens July 20, 2026. Full APSCHE-notified schedule with web options, allotment and reporting dates.",
    url,
...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Only the first phase has been notified so far, running July 20 to August 13, 2026. APSCHE typically conducts further phases for leftover and cancelled seats, but those dates have not been announced yet.",
  },
  {
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <p className="text-sm text-gray-600 mb-6 leading-relaxed">
        ...
        (published in newspapers July 17). <strong>Registration opens July 20</strong> on{" "}
        <a
        ...
        , and the phase runs through August 13. Last updated: July 17, 2026.
      </p>
      ...
      >
        <div className="p-4 sm:p-6">
          <h2 className="text-base sm:text-xl font-bold text-white mb-1">
            Build your options list before July 25
          </h2>
      ...
      <p className="text-xs text-gray-500 leading-relaxed">
        ...
        {AP_NOTIFICATION_TRAIL.map(t => `${t.event}: ${t.date}`).join("; ")}. Only the first
        phase has been notified. Dates can be revised by the council — always confirm on{" "}
        <a

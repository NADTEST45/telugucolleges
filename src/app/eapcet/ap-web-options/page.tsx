    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <section className="rounded-xl mb-6 p-4 sm:p-5 bg-green-50 border border-green-200">
        <h2 className="text-base sm:text-lg font-bold text-green-900 mb-1.5">
          Historical first-phase window: July 25–31, 2026
        </h2>
        <p className="text-sm text-green-900 leading-relaxed">
          These published dates have passed. Check the official portal for any current round.
          The July 16 notification scheduled the following: register and pay the

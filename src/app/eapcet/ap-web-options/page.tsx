...
const FAQS: { q: string; a: string }[] = [
  {
    ...
    a: "The schedule is announced with the counselling notification after results (results are expected June 18–21, 2026). Round-1 web options entry is expected in July 2026. Dates are published on eapcet-sche.aptonline.in and cets.apsche.ap.gov.in.",
  },
  {

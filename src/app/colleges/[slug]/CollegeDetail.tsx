...
function ShareButtons({ collegeName, district, state }: { collegeName: string; district: string; state: string }) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <a href={twUrl} target="_blank" rel="noopener noreferrer"
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/5 text-gray-700 text-xs font-semibold hover:bg-black/10 transition-colors">
        <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        X
      </a>
      <a href={tgUrl} target="_blank" rel="noopener noreferrer"
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0088cc]/10 text-[#0088cc] text-xs font-semibold hover:bg-[#0088cc]/20 transition-colors">
...
function FAQAccordionItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border border-gray-200 rounded-xl overflow-hidden">
      ...
      {open && (
        <div className="px-3 sm:px-5 pb-3 sm:pb-4 text-xs sm:text-sm text-gray-600 leading-relaxed border-t border-gray-100 pt-2 sm:pt-3">
          {answer}
        </div>
      )}
    </div>

...
export default async function FeesPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Fees & Courses", item: `${SITE_URL}/colleges/${c.slug}/fees` },
    ],
  };
  ...
  return (
    <>
      ...
      />
      <CollegeDetail c={c} similar={similar} historicalCutoffs={historicalCutoffs} cutoffYears={cutoffYears} phaseCutoffs={phaseCutoffs} phases={phases} faqs={faqs} initialTab="fees" />
    </>
  );
}
